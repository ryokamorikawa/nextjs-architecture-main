...
export class Convert {
  public static toWeatherModel(json: string): CurrentWeather {
    return cast(JSON.parse(json), r('WeatherModel'));
  }

  public static weatherModelToJson(value: CurrentWeather): string {
...
const typeMap: any = {
  ...
  Coord: o(
    [
      { json: 'lon', js: 'lon', typ: u(undefined, 0) },
      { json: 'lat', js: 'lat', typ: u(undefined, 0) },
    ],
    false
  ),
  Main: o(
    [
      ...
      { json: 'feels_like', js: 'feels_like', typ: u(undefined, 3.14) },
  ...
  Rain: o([{ json: '1h', js: '1h', typ: u(undefined, 3.14) }], false),
  Sys: o(
    [
